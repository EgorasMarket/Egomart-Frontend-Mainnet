...
export const TVChartContainer = () => {
	...
	useEffect(() => {
		...
		const widgetOptions = {
			...
			enabled_features: ['study_templates', 'custom_resolutions', 'show_spread_operators','symbol_search_complete', 'pay_attention_to_ticker_not_symbol', 'disable_resolution_rebuild'],

      ...
      <div className="ExchangeMarket_div1">
        ...
        <div className="ExchangeMarket_div1_body">
          <div className="ExchangeMarket_div1_body_cont1">
            ...
            <div className="ExchangeMarket_div1_body_cont1_amount">$192M</div>
          </div>
          <div className="ExchangeMarket_div1_body_cont1">
            <div className="ExchangeMarket_div1_body_cont1_title">
              24h Trades
            </div>
            <div className="ExchangeMarket_div1_body_cont1_amount">105,931</div>
          </div>
          <div className="ExchangeMarket_div1_body_cont1">
            <div className="ExchangeMarket_div1_body_cont1_title">
              All Time Volume
            </div>
            <div className="ExchangeMarket_div1_body_cont1_amount">$113B</div>
          </div>
          <div className="ExchangeMarket_div1_body_cont1">
            <div className="ExchangeMarket_div1_body_cont1_title">
              All Time Trades
      ...
      <div className="ExchangeMarket_div2">
        ...
        <div className="ExchangeMarket_div2_body">
          <div className="ExchangeMarket_div2_body_header">
            ...
            <div className="ExchangeMarket_div2_body_header_1">24h Change</div>
